HELLO THERE ! THIS BOT JOINS Google Meet AUTOMATICALLY BY IMAGE RECOGNITION AT SCHEDULED TIME WITH THE LINK, IF THERE ARE LESS THAN 10 PEOPLE IN THE MEETING AFTER 30 MINUTES OF JOINING, IT WILL QUIT THAT MEETING AND JOIN THE NEXT ONE.
IT ALSO MUTES YOUR MIC AND DISABLES VIDEO BEFORE ENTERING THE MEETING.

ONLY WORKS ON CHROME BROWSER!!!! THE CHROME BROWSER MUST NOT HAVE DARK THEME ENABLED !!!!! SET IT TO DEFAULT THEME!!!! DO NOT KEEP ANY OTHER PROCESS OR APPLICATION RUNNING!!!
...
DOUBLE CLICK ON THE FILE main.py IN YOUR C DRIVE ( COPY THE main.py FILE TO YOUR DESKTOP AND DOUBLE CLICK IT FROM THERE )
