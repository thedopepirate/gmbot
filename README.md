HELLO THERE ! THIS BOT JOINS Google Meet AUTOMATICALLY BY IMAGE RECOGNITION AT SCHEDULED TIME WITH THE LINK, IF THERE ARE LESS THAN 10 ATTENDEES IN THE MEETING AFTER 30 MINUTES IT WILL QUIT THAT MEETING, ELSE IT WILL KEEP ON CHECKING THE ATTENDEES AT AN INTERVAL OF 5 MINUTES. ONCE IT EXITS, IT JOINS THE NEXT ONE. 
IT ALSO MUTES YOUR MIC AND DISABLES VIDEO BEFORE ENTERING THE MEETING.

***ONLY WORKS ON CHROME BROWSER!!!! SET IT AS YOUR DEFAULT BROWSER***

***THE CHROME BROWSER MUST NOT HAVE DARK THEME ENABLED !!!!!***

***SET IT TO DEFAULT THEME!!!!***

***DO NOT KEEP ANY OTHER PROCESS OR APPLICATION RUNNING!!!!!!***

***DO NOT GET INTO FULL SCREEN MODE ONCE THE BOT JOINS THE MEETING!!!!!***

***RECENTLY FOUND THAT THE BOT DOESN'T CLICK THE JOIN BUTTON NOR MUTE, THIS IS BECAUSE IT FAILS TO RECOGNISE THE BUTTONS. ALL YOU HAVE TO DO IS TAKE A SCREENSHOT OF THE "JOIN NOW" BUTTON OR "ASK TO JOIN" BUTTON AND REPLACE IT WITH THE JOINN OR JOINSS IMAGE IN THE GMBOT FOLDER (CROP IT PRECISELY ) TAKE A SCREENSHOT OF THE EXTENSION (RADIUM COLOR) AND REPLACE IT WITH "WHTEXT" IMAGE. IT WILL WORK NOW ***
...
DOUBLE CLICK ON THE FILE main.py IN YOUR C DRIVE ( COPY THE main.py FILE TO YOUR DESKTOP AND DOUBLE CLICK IT FROM THERE WHENEVER YOU WANT TO JOIN)
