...
IF THE BOT DOESN'T CLICK THE JOIN BUTTON OR MUTE, THIS IS BECAUSE IT FAILS TO RECOGNISE THE BUTTONS. ALL YOU HAVE TO DO IS TAKE A SCREENSHOT OF THE "JOIN NOW" BUTTON OR "ASK TO JOIN" BUTTON AND REPLACE IT WITH THE joinn.png OR joinss.png IMAGE IN THE GMBOT FOLDER (CROP IT PRECISELY) TAKE A SCREENSHOT OF THE EXTENSION (RADIUM COLOR) AND REPLACE IT WITH whtext.png IMAGE.
